...
def train_collate_fn(batch):
    ...
    inputs = processor(text=prompts, images=images, suffix=labels, return_tensors="pt", padding=True, truncation=True, max_length=config.get("max_length"), truncation_side="right")
...
def test_collate_fn(batch):
    ...
    inputs = processor(text=prompts, images=images, return_tensors="pt", padding=True, truncation=True, truncation_side="right")
